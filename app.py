...
def generate_team():
    try:
      ...
      try:
        final_pool, mean_score = func_timeout(6, SimpleGeneticAlgorithm, args=(pre_processed_data, designation, no_generations))
        return jsonify({ "status": 200, "respone": { "final_pool": final_pool, "mean_score": mean_score } })
