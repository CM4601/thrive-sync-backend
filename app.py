...
def generate_team():
    try:
      ...
      try:
        final_pool, mean_score, mean_parent_scores = func_timeout(15, SimpleGeneticAlgorithm, args=(pre_processed_data, designation, no_generations))
        return jsonify({ "status": 200, "respone": { "final_pool": final_pool, "mean_score": mean_score, "mean_parent_scores": mean_parent_scores } })
      
      except FunctionTimedOut:
        return jsonify({"message": "Function timed out after 15 seconds."}), 504
